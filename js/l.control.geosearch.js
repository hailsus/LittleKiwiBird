...
L.Control.GeoSearch = L.Control.extend({
    ...
    _showLocation: function (location) {
        if (this.options.showMarker == true) {
            //displayPoint([location.Y, location.X]);
            console.log("******Lat, Lon : " + location.Y + ", " + location.X);
            if(!(userMarker == null)){
               removeCurrentMarker();
            }
            console.log(location.Label);
            addMarkerAtPosition([location.Y, location.X], location.Label);
        ...
        document.getElementById("locationString").value = location.Label;
        locationAddress = location.Label;
        locationLatLong = [location.Y,  location.X]
